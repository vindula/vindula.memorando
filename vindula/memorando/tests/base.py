...
def setup_product():
    ...
    import vindula.memorando
    zcml.load_config('configure.zcml', vindula.memorando)
    ...
    ztc.installPackage('vindula.memorando')
...
setup_product()
ptc.setupPloneSite(products=['vindula.memorando'])
